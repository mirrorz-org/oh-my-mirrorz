...
big = {
    ...
    'ubuntu-releases': '/22.04/ubuntu-22.04.1-desktop-amd64.iso',
    'debian-cd': '/current/amd64/iso-bd/debian-edu-11.6.0-amd64-BD-1.iso',
    'kali-images': '/kali-2022.4/kali-linux-2022.4-live-amd64.iso',
    'CTAN': '/systems/texlive/Images/texlive2022.iso',
